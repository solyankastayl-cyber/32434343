...
const DriverRow = styled.div`
  ...
  .score { font-weight: 600; font-family: monospace; text-align: right; }
  .impact { font-weight: 700; font-family: monospace; text-align: right; }
`;
...
const ContribCard = styled.div`
  ...
  .score { font-weight: 700; font-family: monospace; font-size: 10px;
    color: ${({ $signal }) => 
